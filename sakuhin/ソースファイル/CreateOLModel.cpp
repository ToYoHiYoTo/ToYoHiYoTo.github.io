...
void CreateOLModel::Load(const char *FileName)
{
	...
	{
		model.VertexArray[i].Position.x = model.VertexArray[i].Position.x + model.VertexArray[i].Normal.x * MODEL_OUTLINE;
		model.VertexArray[i].Position.y = model.VertexArray[i].Position.y + model.VertexArray[i].Normal.y * MODEL_OUTLINE;
		model.VertexArray[i].Position.z = model.VertexArray[i].Position.z + model.VertexArray[i].Normal.z * MODEL_OUTLINE;
	}
...
//モデル読込////////////////////////////////////////////
void CreateOLModel::LoadObj(const char *FileName, MODEL *Model)
{
...
//マテリアル読み込み///////////////////////////////////////////////////////////////////
void CreateOLModel::LoadMaterial(const char *FileName, MODEL_MATERIAL **MaterialArray, unsigned short *MaterialNum)
{
	char str[256];
